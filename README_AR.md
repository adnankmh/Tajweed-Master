...
## تحديث V14 — عرض المصحف الاحترافي

هذه النسخة تركّز على إصلاح عرض المصحف وجعل ألوان أحكام التجويد على الحروف نفسها بدون علامات جانبية أو تداخلات:

- تلوين الحروف نفسها بصريًا مع الحفاظ على اتصال الكلمة العربية وعدم تقسيم النص إلى مقاطع منفصلة.
- رسم النص القرآني كاملًا كفقرة واحدة ثم إعادة رسم مواضع الأحكام فقط بنفس تخطيط النص، وهذا يقلل تداخلات الحروف والفراغات.
- تحسين محاذاة المصحف إلى اليمين بدل التبرير المبالغ فيه الذي كان يسبب فراغات وتداخلات.
- تقليل ازدواج شريط الإعدادات العلوي وتصحيح زر الإعدادات ليفتح صفحة الإعدادات مباشرة.
- تحسين خلفية المصحف والحاويات لتكون أنظف وأكثر ثباتًا على الجوال والكمبيوتر.

ملاحظة علمية: تلوين الأحكام ما زال تعليميًا وخوارزميًا، وللنشر الرسمي كمصحف تجويد معتمد يجب مراجعة قاعدة التلوين حرفًا بحرف من مختص تجويد.
